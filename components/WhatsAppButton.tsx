...
export default function WhatsAppButton() {
  const message = "Olá, Thais! Vim pelo seu site e gostaria de tirar uma dúvida sobre os serviços.";
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      aria-label="Falar com a Thais no WhatsApp"
    >
      ...
      <span className="wa-label">Falar com a Thais</span>
    </a>
  );
}
